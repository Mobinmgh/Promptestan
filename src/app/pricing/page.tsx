...
export const metadata: Metadata = {
  title: "قیمت‌گذاری",
  description: "مقایسه پلن رایگان و حرفه‌ای پرامپتستان برای دسترسی به پرامپت‌های تصویری آماده.",
  openGraph: {
    title: "قیمت‌گذاری پرامپتستان",
    description: "پلن رایگان و حرفه‌ای پرامپتستان برای سازندگان محتوا، فروشگاه‌ها و تیم‌های بازاریابی.",
    locale: "fa_IR",
    siteName: "پرامپتستان",
    url: "/pricing",
  },
...
const plans = [
  {
    ...
    cta: "شروع رایگان",
    highlighted: false,
    features: ["دسترسی به پرامپت‌های رایگان", "پیش‌نمایش پرامپت‌های حرفه‌ای", "ذخیره پرامپت‌ها"],
  },
  {
    name: "حرفه‌ای",
