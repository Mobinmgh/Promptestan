...
export function PromptCard({
  ...
  return (
    <article className="group relative mb-6 break-inside-avoid overflow-hidden rounded-xl border border-border bg-surface transition duration-200 hover:-translate-y-1 hover:border-accent/80 hover:shadow-glow">
      ...
      <div className="hidden md:block">
        <div className="absolute left-3 top-3 z-20 opacity-0 transition duration-200 group-hover:opacity-100">
          <FavoriteButton promptId={prompt.id} slug={prompt.slug} isLoggedIn={isLoggedIn} isSaved={isSaved} />
        </div>
      </div>
    </article>
